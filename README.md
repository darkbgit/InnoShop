...
- Микросервис должен предоставлять RESTful API для создания, чтения,
...
- Должны быть предусмотрены механизмы обработки ошибок и валидации данных.
  (Fluent Validation, Problem Details as Exception handler or Custom global exception
  middleware)
...
- Взаимодействие между микросервисами должно быть реализовано с
  использованием RESTful API.
- Для аутентификации и авторизации пользователей следует использовать JWT (JSON Web Tokens).
- Для хранения данных микросервиса можно использовать СУБД (например,
